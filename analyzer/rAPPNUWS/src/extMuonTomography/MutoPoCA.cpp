...
void MutoPoCA::SetGrid(unsigned int nx, unsigned int ny, unsigned int nz, double x_min, double y_min, double z_min, double dx, double dy, double dz) {
    fGrid.nx = nx;
    fGrid.ny = ny;
    fGrid.nz = nz;
    fGrid.x_min = x_min;
...
void MutoPoCA::SetGrid(VoxelGrid grid) {
    fGrid = grid;
}

void MutoPoCA::setAngMag(MTfloat fAngMag) {
    this->fAngMag = fAngMag;
}

void MutoPoCA::setEps(MTfloat fEps) {
    fEPS = fEps;
}

void MutoPoCA::setHasEnergy(bool fHasEnergy) {
    this->fHasEnergy = fHasEnergy;
}

void MutoPoCA::setLengthWeighted(bool fLengthWeighted) {
    this->fLengthWeighted = fLengthWeighted;
}

void MutoPoCA::setLogPrint(bool fLogPrint) {
    this->fLogPrint = fLogPrint;
}

void MutoPoCA::setNNotParallel(int fNNotParallel) {
    this->fNNotParallel = fNNotParallel;
}

void MutoPoCA::setNScatInGrid(int fNScatInGrid) {
    this->fNScatInGrid = fNScatInGrid;
}

void MutoPoCA::setNTotal(int fNTotal) {
    this->fNTotal = fNTotal;
}

void MutoPoCA::setStraightLine(bool fStraightLine) {
    this->fStraightLine = fStraightLine;
}
