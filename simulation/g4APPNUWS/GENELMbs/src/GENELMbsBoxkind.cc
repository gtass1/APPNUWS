...
//    _ros=ros;
  ...
  void Boxkind::setPosMatrix( HepGeom::Transform3D &lPos ) {
...
//  const CLHEP::Hep3Vector& Boxkind::getROChLoclMidPoint(unsigned long id)  const {
