...
APPNWG4DetectorMessenger::APPNWG4DetectorMessenger(APPNWG4DetectorConstruction* Det)
 : G4UImessenger(),
   fDetectorConstruction(Det)
{
  ...
  fDetConfigCmd = new G4UIcmdWithAString("/B2/det/setConfigFile", this);
  fDetConfigCmd->SetGuidance("Set filename to read detector geometry ");
  fDetConfigCmd->SetParameterName("name", false);
...
APPNWG4DetectorMessenger::~APPNWG4DetectorMessenger()
{
  //  delete fTargMatCmd;
  //  delete fChamMatCmd;
  delete fStepMaxCmd;
  ...
  delete fDetConfigCmd;

}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void APPNWG4DetectorMessenger::SetNewValue(G4UIcommand* command,G4String newValue)
{

  //if ( command == fDetConfigCmd)
   //fDetectorConstruction->SetConfigFile(newValue);
