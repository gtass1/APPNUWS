...
APPNWG4FieldMessenger::APPNWG4FieldMessenger(APPNWG4FieldSetup* fieldSetup)
 : G4UImessenger(),
   ...
   fUpdateCmd(0)
{
  ...
  fFieldDir->SetGuidance("APPNWG4 field tracking control.");
...
APPNWG4FieldMessenger::~APPNWG4FieldMessenger()
{
  delete fStepperCmd;
...
void APPNWG4FieldMessenger::SetNewValue( G4UIcommand* command, G4String newValue)
{
