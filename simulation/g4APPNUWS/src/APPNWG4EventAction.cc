...
APPNWG4EventAction::APPNWG4EventAction()
: G4UserEventAction() {
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void APPNWG4EventAction::BeginOfEventAction(const G4Event*) {

}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void APPNWG4EventAction::EndOfEventAction(const G4Event* event) {
  ...
  if (trajectoryContainer) {
    ...
    std::vector<SimG4Particle*> cnttracks;
    //TClonesArray  cnttracks("SimG4Particle",100000);
    for (G4int i=0;i<n_trajectories;i++) {
      G4VTrajectory *tmpTrk = (*trajectoryContainer)[i];
      cnttracks.push_back( new SimG4Particle( tmpTrk->GetTrackID(),
                                     tmpTrk->GetParentID(),
