// interface to manage the geometries of the DCH base cells
//
// Original author G. Tassielli
//

#ifndef CellGeometryHandle_BS_hh
#define CellGeometryHandle_BS_hh
...
//          e.error();
//        }
        virtual void  SelectCell(int CellLayer, int Cell, bool type=false) {
        	//                throw cet::exception("GEOM")<< "SelectCell Method not implemented for the interface class CellGeometryHandle, please use one of the real implementation"<<std::endl;
        	exc::exceptionG4 e("GEOM","Fatal Error",0);
        	e<<"SelectCell Method not implemented for the interface class CellGeometryHandle, please use one of the real implementation \n";
        	e<<"Ignored arguments "<<CellLayer<<" "<<Cell<<" "<<type<<"\n";
        	e.error();
        }

        virtual void  SelectCell(int SupLayer, int CellLayer, int Cell, bool type=false) {
        	//                throw cet::exception("GEOM")<< "SelectCell Method not implemented for the interface class CellGeometryHandle, please use one of the real implementation"<<std::endl;
        	exc::exceptionG4 e("GEOM","Fatal Error",0);
        	e<<"SelectCell Method not implemented for the interface class CellGeometryHandle, please use one of the real implementation \n";
        	e<<"Ignored arguments "<<SupLayer<<" "<<CellLayer<<" "<<Cell<<" "<<type<<"\n";
        	e.error();
        }
...
//
                int fLayer=(int)(det*0.001);

                //Return the Wire
                int fWire=(int)((det)-fLayer*1000);
//
//                fSuperLayer--;
//
//                //Call the upper method
//                /*CellGeometryHandle::*/SelectCell(fSuperLayer,fLayer,fWire);
                SelectCell(fLayer,fWire);
        }
...
//        }
        ...
        virtual unsigned long computeDet(int CellLayer, int Cell) {
                unsigned long det = ((CellLayer)*1000)+(Cell);
                return det;
        }

        virtual unsigned long computeDet(int SupLayer, int CellLayer, int Cell, bool type=false) {
        	exc::exceptionG4 e("GEOM","Fatal Error",0);
        	e<<"computeDet Method not implemented for the interface class CellGeometryHandle, please use one of the real implementation \n";
        	e<<"Ignored arguments "<<SupLayer<<" "<<CellLayer<<" "<<Cell<<" "<<type<<"\n";
        	e.error();
        	return 0;
        }
...
#endif /* CellGeometryHandle_BS_hh */
