...
#ifndef FoilDetail_BS_hh
#define FoilDetail_BS_hh
...
public:
  ...
  FoilDetail( std::vector<double> & thicknesses, std::vector<std::string> & materialNames,
               double halfLength
               );
...
//          }
    try {
      ...
      e<< "No material defined for the foil \n";
      e.error();
    }
...
//          }
    try {
      ...
      exc::exceptionG4 e("GEOM","Fatal Error in Arguments",1);
      e<< "No shells thicknesses defined for the foil \n";
      e.error();
    }
