...
#ifndef SimG4TrackerHit_h
#define SimG4TrackerHit_h 1
...
class SimG4TrackerHit : public G4VHit
{
  public:
    SimG4TrackerHit();
    SimG4TrackerHit(G4int trackID,G4int chamberNb,G4double edep,G4double noIEdep,G4double gtime,G4double ptime,G4ThreeVector pos,G4ThreeVector end,G4ThreeVector mom,G4double len,G4String pcode);

    SimG4TrackerHit(const SimG4TrackerHit&);

    virtual ~SimG4TrackerHit();

    // operators
    const SimG4TrackerHit& operator=(const SimG4TrackerHit&);
    G4int operator==(const SimG4TrackerHit&) const;
...
//   ClassDef(SimG4TrackerHit,0);

};

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

typedef G4THitsCollection<SimG4TrackerHit> SimG4TrackerHitsCollection;

extern G4ThreadLocal G4Allocator<SimG4TrackerHit>* SimG4TrackerHitAllocator;

#ifndef __CINT__
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

inline void* SimG4TrackerHit::operator new(size_t)
{
  if(!SimG4TrackerHitAllocator)
      SimG4TrackerHitAllocator = new G4Allocator<SimG4TrackerHit>;
  return (void *) SimG4TrackerHitAllocator->MallocSingle();
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

inline void SimG4TrackerHit::operator delete(void *hit)
{
  SimG4TrackerHitAllocator->FreeSingle((SimG4TrackerHit*) hit);
}
#endif
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
